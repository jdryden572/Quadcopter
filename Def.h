...
#define ANG_ROLL_KP ANG_KP
#define ANG_ROLL_KI ANG_KI / PID_SMPLRT
#define ANG_ROLL_KD ANG_KD * PID_SMPLRT

#define ANG_PITCH_KP ANG_KP
#define ANG_PITCH_KI ANG_KI / PID_SMPLRT
#define ANG_PITCH_KD ANG_KD * PID_SMPLRT

#define RATE_ROLL_KP RATE_KP
#define RATE_ROLL_KI RATE_KI / PID_SMPLRT
#define RATE_ROLL_KD RATE_KD * PID_SMPLRT

#define RATE_PITCH_KP RATE_KP
#define RATE_PITCH_KI RATE_KI / PID_SMPLRT
#define RATE_PITCH_KD RATE_KD * PID_SMPLRT

#define RATE_YAW_KP YAW_KP
#define RATE_YAW_KI YAW_KD / PID_SMPLRT
#define RATE_YAW_KD YAW_KI * PID_SMPLRT
